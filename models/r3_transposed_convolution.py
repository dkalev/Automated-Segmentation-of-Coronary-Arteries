...
import e3cnn.nn
from e3cnn.nn import FieldType
from e3cnn.nn import GeometricTensor
from e3cnn.gspaces import *
from e3cnn.group import Representation, Group
from e3cnn.kernels import KernelBasis

from e3cnn.nn.modules.equivariant_module import EquivariantModule

from e3cnn.nn.modules.basismanager import BasisManager
from e3cnn.nn.modules.basismanager import BlocksBasisExpansion
...
# TODO:  Inherit from RDConvTransposed


class R3ConvTransposed(EquivariantModule):
    ...
    def __init__(self,
        ...
        .. warning ::
            ...
            We suggest using :class:`~e3cnn.nn.R3Upsampling` combined with :class:`~e3cnn.nn.R3Conv` to perform
            upsampling.

        .. seealso ::
            For additional information about the parameters and the methods of this class, see :class:`e3cnn.nn.R3Conv`.
        ...
        if basisexpansion == 'blocks':
            self._basisexpansion = BlocksBasisExpansion(in_type.representations,
        ...
        if initialize:
            ...
            e3cnn.nn.init.generalized_he_init(self.weights.data, self.basisexpansion)
    ...
    def expand_parameters(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        _filter = _filter.reshape(_filter.shape[0], _filter.shape[1], self.kernel_size, self.kernel_size, self.kernel_size)
    ...
    def train(self, mode=True):
        ...
        return super(R3ConvTransposed, self).train(mode)
...
def get_grid_coords(d: int, kernel_size: int, dilation: int = 1):
...
def compute_basis_params(kernel_size: int,
    ...
    grid = get_grid_coords(3, kernel_size, dilation)
