...
class IcoCNN(BaseEquiv):
    def __init__(self, *args, kernel_size=5, initialize=True, **kwargs):
        super().__init__(*args, **kwargs)

        type240 = enn.FieldType(self.gspace, 4*[self.gspace.regular_repr])
        type600 = enn.FieldType(self.gspace, 10*[self.gspace.regular_repr])
        type_final = enn.FieldType(self.gspace, 40*[self.gspace.fibergroup.ico_edges_representation])
